...
from scripts.article_seo import detect_cms, extract_keywords_frequency, extract_structured_data


DATA_FILE = Path(__file__).parent / "data" / "article_seo_cases.json"
