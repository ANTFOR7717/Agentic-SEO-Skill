...
from performance.analyze_visual import analyze_visual


class TestAnalyzeVisual(unittest.TestCase):
    @patch("performance.analyze_visual.sync_playwright")
    ...
    def test_analyze_visual_returns_dict(self):
        with patch("performance.analyze_visual.sync_playwright"):
            result = analyze_visual("https://example.com")
